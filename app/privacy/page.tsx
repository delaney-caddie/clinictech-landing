    ...
    <>
      ...
      <div className="legal-page">
        ...
        <div className="legal-content">
          ...
          <p><strong>Help:</strong> Reply <strong>HELP</strong> to any message for support information, or contact us at support@clinictech.io.</p>
          ...
          <p>To exercise any of these rights, contact us at <a href="mailto:support@clinictech.io">support@clinictech.io</a>.</p>
