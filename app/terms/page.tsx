...
export const metadata = {
  title: "Terms of Service - ClinicTech",
  description: "ClinicTech terms of service. Messaging program terms, opt-out instructions, and usage guidelines.",
};
    ...
    <>
      ...
      <div className="legal-page">
        ...
        <div className="legal-content">
          ...
          <p>By accessing or using ClinicTech&apos;s website (clinictech.io), platform (app.clinictech.io), or any related services (collectively, the &ldquo;Services&rdquo;), you agree to be bound by these Terms of Service. ClinicTech is operated by Caddie AI Inc.</p>

          <h2>Description of Services</h2>
          <p>ClinicTech provides a CRM and patient engagement platform for regenerative medicine and wellness clinics. Our Services include smart intake forms, automated follow-up sequences, patient portals, review generation, online scheduling, and travel concierge tools.</p>

          <h2>SMS Messaging Program</h2>
          <h3>Program name</h3>
          <p>ClinicTech Patient Messaging</p>

          <h3>Program description</h3>
          <p>ClinicTech sends text messages on behalf of regenerative medicine and wellness clinics to their patients and leads. Messages include appointment reminders, lead follow-ups, intake form links, treatment information, and post-treatment check-ins.</p>

          <h3>Consent</h3>
          <p>By providing your phone number and checking the SMS consent checkbox on a ClinicTech-powered intake form, website contact form, or during a clinic consultation, you consent to receive text messages from ClinicTech or the clinic you are engaging with. Consent is not required as a condition of purchasing any goods or services.</p>
          ...
          <h2>HIPAA</h2>
          <p>ClinicTech implements security measures aligned with HIPAA requirements. Clinics using our platform to handle protected health information (PHI) should contact us to execute a Business Associate Agreement (BAA).</p>
